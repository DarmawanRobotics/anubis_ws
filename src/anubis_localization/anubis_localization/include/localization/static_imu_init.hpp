...
namespace localization
{
    ...
    public:
        ...
        inline size_t GetInitAttemptCount() const
        {
            return init_attempt_count_;
        }

        inline size_t GetLastAttemptSampleCount() const
        {
            return last_attempt_sample_count_;
        }

        inline double GetLastAttemptDurationSeconds() const
        {
            return last_attempt_duration_seconds_;
        }
    ...
    private:
        ...
        size_t          init_attempt_count_ = 0;
        size_t          last_attempt_sample_count_ = 0;
        double          last_attempt_duration_seconds_ = 0.0;
